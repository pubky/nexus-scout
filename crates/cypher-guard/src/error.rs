...
///
/// Each variant maps to a stable, caller-facing [`hint`](RejectReason::hint).
...
///
/// Carries the [`RejectReason`] and, when available, the byte span in the
/// original query that triggered the rejection.
